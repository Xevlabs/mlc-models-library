export enum TransactionOperationTypeEnum {
    ...
    CONTINUE_TRANSACTION_AFTER_TRANSFER = 'CONTINUE_TRANSACTION_AFTER_TRANSFER',
    CHECK_IF_TRANSACTION_VALID = 'CHECK_IF_TRANSACTION_VALID',
    FIREBLOCKS_TRANSACTION_ERROR = 'FIREBLOCKS_TRANSACTION_ERROR',
    SECOND_TRANSFER_CANCELLED = 'SECOND_TRANSFER_CANCELLED',
    TRANSACTION_CANCELLED_AFTER_ERROR = 'TRANSACTION_CANCELLED_AFTER_ERROR',
}
