export enum ErrorsEnum {
    ...
    BENEFICIARY_WITH_SAME_IBAN_ALREADY_EXISTS = 'BENEFICIARY_WITH_SAME_IBAN_ALREADY_EXISTS',
    BENEFICIARY_WITH_SAME_FULLNAME_ALREADY_EXISTS = 'BENEFICIARY_WITH_SAME_FULLNAME_ALREADY_EXISTS',
    ...
    COMPANY_VALID_PAYIN_REQUIRED = 'COMPANY_VALID_PAYIN_REQUIRED',
    ...
    LEFTOVER_AFTER_WITHDRAWAL_LOWER_THAN_MINIMUN = 'LEFTOVER_AFTER_WITHDRAWAL_LOWER_THAN_MINIMUN',
    METHOD_NOT_ALLOWED = 'METHOD_NOT_ALLOWED',
    MISSING_REQUIRED_TREEZOR_DOCUMENT = 'MISSING_REQUIRED_TREEZOR_DOCUMENT',
    NO_KYC_DOCUMENT = 'NO_KYC_DOCUMENT',
    ...
    INVALID_COMMON_WALLET_COMPANY_KYC = 'INVALID_COMMON_WALLET_COMPANY_KYC'
}
